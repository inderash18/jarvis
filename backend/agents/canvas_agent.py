"""
Canvas Agent — Controls the drawing canvas.
"""
...
class CanvasAgent(BaseAgent):
    ...
    async def process_request(
        ...
        # Default center of screen (1920×1080)
        default_x = 960
        default_y = 540

        if action == "draw_circle":
            radius_cm = parameters.get("radius_cm", 5)
            radius_px = int(radius_cm * 37.79)  # 96 DPI → 1 cm = 37.79 px
            ...
            x = parameters.get("x", default_x - (width_px // 2))
